...
The current parser-output audit is in [docs/parser-output-audit-2026-06-23.md](docs/parser-output-audit-2026-06-23.md). Use it for current parser sanity findings and semantic follow-up areas. The LIVE block above is generated from current parquet data; some detailed county tables below may lag until the coverage section is regenerated.
